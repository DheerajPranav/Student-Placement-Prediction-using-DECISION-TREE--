...
class gui:
    ...
    def __init__(self,root):
        ...
        tk.Label(frame, text = "Placement Prediction of Students", font = self.head_font, bg = "white", borderwidth=2, relief="solid").place(x = 230, y = 50)
        ...
        predict = tk.Button(frame, text = "Predict", fg = "green",  borderwidth=2, relief="raised", font = self.head_font, command = lambda :self.prediction(frame, answer, name, roll, agg, techskill, comskill, backlogs))
    ...
    def prediction(self,frame, answer, name, roll, agg, techskill, comskill, backlogs):
        ...
        if len(x) == 0 or y == "None" or z == "None" or not k.isdigit():
            ...
            if out:
                ...
                answer.config(text = "You might not get selected",fg = "pink")
